...
function readEntity(rootName, entity) {
  ...
  return { rootName, slug: entity.slug, dir, frontmatter, body, files, baseDir, displayPath, mainFile: mainRelName, maxMtimeMs };
}
...
module.exports = { REPO_ROOT, DOCS_DIR, DOCS_ROOT, ROOTS, scanAll, listEntities, readEntity, findEntityByPath, resolveSafePath };
