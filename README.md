...
Локальный веб-интерфейс для markdown-базы знаний: список карточек с фильтрами по статусу/стеку/тегам, полнотекстовый поиск, создание карточек из шаблонов, дерево файлов, просмотр и редактирование markdown в исходнике или в визуальном WYSIWYG-редакторе (mermaid-диаграммы рендерятся в превью), редактирование frontmatter через форму, мягкое удаление с 30-дневной корзиной, автогенерация `INDEX.md`.
