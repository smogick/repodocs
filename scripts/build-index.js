...
Сводная таблица всех проектов/областей/ресурсов. Сгенерировано автоматически — не редактируй руками, запусти \`node ui/scripts/build-index.js\` после изменений во frontmatter.
